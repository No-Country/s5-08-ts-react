		...
		<div className="w-full flex items-center justify-center py-10">
			<div className="w-full mx-auto">
				...
				>
					{() => (
						<>
							<Listbox.Label className="block text-lg leading-5 text-gray-700">
								{label}
							</Listbox.Label>
							<div className="relative">
									...
									>
										<span className="block truncate">
											{selectedPersons.length < 1
												...
												: `Opciones Seleccionadas (${selectedPersons.length})`}
										</span>
								...
								<div className="pt-1 text-sm h-10">
									{selectedPersons.length > 0 && (
										<span className="text-lg">
											Items Seleccionados: {selectedPersons.join(', ')}
										</span>
									)}
								</div>
							</div>
